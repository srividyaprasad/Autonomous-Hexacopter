...
enum
{
  px4_msgs__msg__ActuatorControls3__NUM_ACTUATOR_CONTROL_GROUPS = 6
};
...
enum
{
  px4_msgs__msg__ActuatorControls3__GROUP_INDEX_ALLOCATED_PART1 = 4
};

/// Constant 'GROUP_INDEX_ALLOCATED_PART2'.
enum
{
  px4_msgs__msg__ActuatorControls3__GROUP_INDEX_ALLOCATED_PART2 = 5
};
