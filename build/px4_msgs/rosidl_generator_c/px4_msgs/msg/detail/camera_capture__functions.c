...
{
  px4_msgs__msg__CameraCapture * msg = (px4_msgs__msg__CameraCapture *)malloc(sizeof(px4_msgs__msg__CameraCapture));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__CameraCapture__Sequence__init(px4_msgs__msg__CameraCapture__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__CameraCapture *)calloc(size, sizeof(px4_msgs__msg__CameraCapture));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__CameraCapture__Sequence * array = (px4_msgs__msg__CameraCapture__Sequence *)malloc(sizeof(px4_msgs__msg__CameraCapture__Sequence));
  if (!array) {
    return NULL;
  }
