...
{
  px4_msgs__msg__CellularStatus * msg = (px4_msgs__msg__CellularStatus *)malloc(sizeof(px4_msgs__msg__CellularStatus));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__CellularStatus__Sequence__init(px4_msgs__msg__CellularStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__CellularStatus *)calloc(size, sizeof(px4_msgs__msg__CellularStatus));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__CellularStatus__Sequence * array = (px4_msgs__msg__CellularStatus__Sequence *)malloc(sizeof(px4_msgs__msg__CellularStatus__Sequence));
  if (!array) {
    return NULL;
  }
