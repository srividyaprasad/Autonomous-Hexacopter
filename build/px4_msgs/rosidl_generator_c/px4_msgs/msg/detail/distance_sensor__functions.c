...
px4_msgs__msg__DistanceSensor__Sequence__init(px4_msgs__msg__DistanceSensor__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__DistanceSensor *)calloc(size, sizeof(px4_msgs__msg__DistanceSensor));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__DistanceSensor__Sequence * array = (px4_msgs__msg__DistanceSensor__Sequence *)malloc(sizeof(px4_msgs__msg__DistanceSensor__Sequence));
  if (!array) {
    return NULL;
  }
