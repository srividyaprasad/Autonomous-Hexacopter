...
{
  px4_msgs__msg__EkfGpsDrift * msg = (px4_msgs__msg__EkfGpsDrift *)malloc(sizeof(px4_msgs__msg__EkfGpsDrift));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__EkfGpsDrift__Sequence__init(px4_msgs__msg__EkfGpsDrift__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__EkfGpsDrift *)calloc(size, sizeof(px4_msgs__msg__EkfGpsDrift));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__EkfGpsDrift__Sequence * array = (px4_msgs__msg__EkfGpsDrift__Sequence *)malloc(sizeof(px4_msgs__msg__EkfGpsDrift__Sequence));
  if (!array) {
    return NULL;
  }
