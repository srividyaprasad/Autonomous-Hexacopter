...
{
  px4_msgs__msg__LandingTargetInnovations * msg = (px4_msgs__msg__LandingTargetInnovations *)malloc(sizeof(px4_msgs__msg__LandingTargetInnovations));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__LandingTargetInnovations__Sequence__init(px4_msgs__msg__LandingTargetInnovations__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__LandingTargetInnovations *)calloc(size, sizeof(px4_msgs__msg__LandingTargetInnovations));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__LandingTargetInnovations__Sequence * array = (px4_msgs__msg__LandingTargetInnovations__Sequence *)malloc(sizeof(px4_msgs__msg__LandingTargetInnovations__Sequence));
  if (!array) {
    return NULL;
  }
