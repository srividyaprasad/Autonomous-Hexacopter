...
{
  px4_msgs__msg__MavlinkLog * msg = (px4_msgs__msg__MavlinkLog *)malloc(sizeof(px4_msgs__msg__MavlinkLog));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__MavlinkLog__Sequence__init(px4_msgs__msg__MavlinkLog__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__MavlinkLog *)calloc(size, sizeof(px4_msgs__msg__MavlinkLog));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__MavlinkLog__Sequence * array = (px4_msgs__msg__MavlinkLog__Sequence *)malloc(sizeof(px4_msgs__msg__MavlinkLog__Sequence));
  if (!array) {
    return NULL;
  }
