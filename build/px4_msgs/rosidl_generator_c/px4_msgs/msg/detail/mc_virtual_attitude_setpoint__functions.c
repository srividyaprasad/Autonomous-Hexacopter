...
{
  px4_msgs__msg__McVirtualAttitudeSetpoint * msg = (px4_msgs__msg__McVirtualAttitudeSetpoint *)malloc(sizeof(px4_msgs__msg__McVirtualAttitudeSetpoint));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence__init(px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__McVirtualAttitudeSetpoint *)calloc(size, sizeof(px4_msgs__msg__McVirtualAttitudeSetpoint));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence * array = (px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence *)malloc(sizeof(px4_msgs__msg__McVirtualAttitudeSetpoint__Sequence));
  if (!array) {
    return NULL;
  }
