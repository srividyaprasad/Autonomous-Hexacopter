...
{
  px4_msgs__msg__OrbTest * msg = (px4_msgs__msg__OrbTest *)malloc(sizeof(px4_msgs__msg__OrbTest));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__OrbTest__Sequence__init(px4_msgs__msg__OrbTest__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__OrbTest *)calloc(size, sizeof(px4_msgs__msg__OrbTest));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__OrbTest__Sequence * array = (px4_msgs__msg__OrbTest__Sequence *)malloc(sizeof(px4_msgs__msg__OrbTest__Sequence));
  if (!array) {
    return NULL;
  }
