...
{
  px4_msgs__msg__OrbTestMediumMulti * msg = (px4_msgs__msg__OrbTestMediumMulti *)malloc(sizeof(px4_msgs__msg__OrbTestMediumMulti));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__OrbTestMediumMulti__Sequence__init(px4_msgs__msg__OrbTestMediumMulti__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__OrbTestMediumMulti *)calloc(size, sizeof(px4_msgs__msg__OrbTestMediumMulti));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__OrbTestMediumMulti__Sequence * array = (px4_msgs__msg__OrbTestMediumMulti__Sequence *)malloc(sizeof(px4_msgs__msg__OrbTestMediumMulti__Sequence));
  if (!array) {
    return NULL;
  }
