...
{
  px4_msgs__msg__OrbTestMediumQueuePoll * msg = (px4_msgs__msg__OrbTestMediumQueuePoll *)malloc(sizeof(px4_msgs__msg__OrbTestMediumQueuePoll));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__OrbTestMediumQueuePoll__Sequence__init(px4_msgs__msg__OrbTestMediumQueuePoll__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__OrbTestMediumQueuePoll *)calloc(size, sizeof(px4_msgs__msg__OrbTestMediumQueuePoll));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__OrbTestMediumQueuePoll__Sequence * array = (px4_msgs__msg__OrbTestMediumQueuePoll__Sequence *)malloc(sizeof(px4_msgs__msg__OrbTestMediumQueuePoll__Sequence));
  if (!array) {
    return NULL;
  }
