...
{
  px4_msgs__msg__OrbTestMediumWrapAround * msg = (px4_msgs__msg__OrbTestMediumWrapAround *)malloc(sizeof(px4_msgs__msg__OrbTestMediumWrapAround));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__OrbTestMediumWrapAround__Sequence__init(px4_msgs__msg__OrbTestMediumWrapAround__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__OrbTestMediumWrapAround *)calloc(size, sizeof(px4_msgs__msg__OrbTestMediumWrapAround));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__OrbTestMediumWrapAround__Sequence * array = (px4_msgs__msg__OrbTestMediumWrapAround__Sequence *)malloc(sizeof(px4_msgs__msg__OrbTestMediumWrapAround__Sequence));
  if (!array) {
    return NULL;
  }
