...
{
  px4_msgs__msg__Ping * msg = (px4_msgs__msg__Ping *)malloc(sizeof(px4_msgs__msg__Ping));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__Ping__Sequence__init(px4_msgs__msg__Ping__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__Ping *)calloc(size, sizeof(px4_msgs__msg__Ping));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__Ping__Sequence * array = (px4_msgs__msg__Ping__Sequence *)malloc(sizeof(px4_msgs__msg__Ping__Sequence));
  if (!array) {
    return NULL;
  }
