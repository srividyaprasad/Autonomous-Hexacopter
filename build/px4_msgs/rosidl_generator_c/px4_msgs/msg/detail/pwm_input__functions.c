...
{
  px4_msgs__msg__PwmInput * msg = (px4_msgs__msg__PwmInput *)malloc(sizeof(px4_msgs__msg__PwmInput));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__PwmInput__Sequence__init(px4_msgs__msg__PwmInput__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__PwmInput *)calloc(size, sizeof(px4_msgs__msg__PwmInput));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__PwmInput__Sequence * array = (px4_msgs__msg__PwmInput__Sequence *)malloc(sizeof(px4_msgs__msg__PwmInput__Sequence));
  if (!array) {
    return NULL;
  }
