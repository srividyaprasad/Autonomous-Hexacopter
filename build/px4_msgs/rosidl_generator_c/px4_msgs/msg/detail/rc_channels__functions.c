...
{
  px4_msgs__msg__RcChannels * msg = (px4_msgs__msg__RcChannels *)malloc(sizeof(px4_msgs__msg__RcChannels));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__RcChannels__Sequence__init(px4_msgs__msg__RcChannels__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__RcChannels *)calloc(size, sizeof(px4_msgs__msg__RcChannels));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__RcChannels__Sequence * array = (px4_msgs__msg__RcChannels__Sequence *)malloc(sizeof(px4_msgs__msg__RcChannels__Sequence));
  if (!array) {
    return NULL;
  }
