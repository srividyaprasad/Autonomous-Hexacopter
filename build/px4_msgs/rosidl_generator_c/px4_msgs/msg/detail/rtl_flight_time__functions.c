...
{
  px4_msgs__msg__RtlFlightTime * msg = (px4_msgs__msg__RtlFlightTime *)malloc(sizeof(px4_msgs__msg__RtlFlightTime));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__RtlFlightTime__Sequence__init(px4_msgs__msg__RtlFlightTime__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__RtlFlightTime *)calloc(size, sizeof(px4_msgs__msg__RtlFlightTime));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__RtlFlightTime__Sequence * array = (px4_msgs__msg__RtlFlightTime__Sequence *)malloc(sizeof(px4_msgs__msg__RtlFlightTime__Sequence));
  if (!array) {
    return NULL;
  }
