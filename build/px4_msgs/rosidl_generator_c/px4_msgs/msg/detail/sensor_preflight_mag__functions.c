...
{
  px4_msgs__msg__SensorPreflightMag * msg = (px4_msgs__msg__SensorPreflightMag *)malloc(sizeof(px4_msgs__msg__SensorPreflightMag));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__SensorPreflightMag__Sequence__init(px4_msgs__msg__SensorPreflightMag__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__SensorPreflightMag *)calloc(size, sizeof(px4_msgs__msg__SensorPreflightMag));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__SensorPreflightMag__Sequence * array = (px4_msgs__msg__SensorPreflightMag__Sequence *)malloc(sizeof(px4_msgs__msg__SensorPreflightMag__Sequence));
  if (!array) {
    return NULL;
  }
