...
{
  px4_msgs__msg__TrajectoryBezier * msg = (px4_msgs__msg__TrajectoryBezier *)malloc(sizeof(px4_msgs__msg__TrajectoryBezier));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__TrajectoryBezier__Sequence__init(px4_msgs__msg__TrajectoryBezier__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__TrajectoryBezier *)calloc(size, sizeof(px4_msgs__msg__TrajectoryBezier));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__TrajectoryBezier__Sequence * array = (px4_msgs__msg__TrajectoryBezier__Sequence *)malloc(sizeof(px4_msgs__msg__TrajectoryBezier__Sequence));
  if (!array) {
    return NULL;
  }
