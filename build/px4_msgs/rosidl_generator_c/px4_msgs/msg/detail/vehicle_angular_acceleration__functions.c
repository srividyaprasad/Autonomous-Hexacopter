...
{
  px4_msgs__msg__VehicleAngularAcceleration * msg = (px4_msgs__msg__VehicleAngularAcceleration *)malloc(sizeof(px4_msgs__msg__VehicleAngularAcceleration));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__VehicleAngularAcceleration__Sequence__init(px4_msgs__msg__VehicleAngularAcceleration__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__VehicleAngularAcceleration *)calloc(size, sizeof(px4_msgs__msg__VehicleAngularAcceleration));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__VehicleAngularAcceleration__Sequence * array = (px4_msgs__msg__VehicleAngularAcceleration__Sequence *)malloc(sizeof(px4_msgs__msg__VehicleAngularAcceleration__Sequence));
  if (!array) {
    return NULL;
  }
