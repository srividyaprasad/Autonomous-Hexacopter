...
{
  px4_msgs__msg__VehicleCommand * msg = (px4_msgs__msg__VehicleCommand *)malloc(sizeof(px4_msgs__msg__VehicleCommand));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__VehicleCommand__Sequence__init(px4_msgs__msg__VehicleCommand__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__VehicleCommand *)calloc(size, sizeof(px4_msgs__msg__VehicleCommand));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__VehicleCommand__Sequence * array = (px4_msgs__msg__VehicleCommand__Sequence *)malloc(sizeof(px4_msgs__msg__VehicleCommand__Sequence));
  if (!array) {
    return NULL;
  }
