...
{
  px4_msgs__msg__VehicleCommandAck * msg = (px4_msgs__msg__VehicleCommandAck *)malloc(sizeof(px4_msgs__msg__VehicleCommandAck));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__VehicleCommandAck__Sequence__init(px4_msgs__msg__VehicleCommandAck__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__VehicleCommandAck *)calloc(size, sizeof(px4_msgs__msg__VehicleCommandAck));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__VehicleCommandAck__Sequence * array = (px4_msgs__msg__VehicleCommandAck__Sequence *)malloc(sizeof(px4_msgs__msg__VehicleCommandAck__Sequence));
  if (!array) {
    return NULL;
  }
