...
{
  px4_msgs__msg__VehicleGpsPosition * msg = (px4_msgs__msg__VehicleGpsPosition *)malloc(sizeof(px4_msgs__msg__VehicleGpsPosition));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__VehicleGpsPosition__Sequence__init(px4_msgs__msg__VehicleGpsPosition__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__VehicleGpsPosition *)calloc(size, sizeof(px4_msgs__msg__VehicleGpsPosition));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__VehicleGpsPosition__Sequence * array = (px4_msgs__msg__VehicleGpsPosition__Sequence *)malloc(sizeof(px4_msgs__msg__VehicleGpsPosition__Sequence));
  if (!array) {
    return NULL;
  }
