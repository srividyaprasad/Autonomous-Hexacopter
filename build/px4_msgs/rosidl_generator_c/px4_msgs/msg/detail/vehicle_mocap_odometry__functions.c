...
{
  px4_msgs__msg__VehicleMocapOdometry * msg = (px4_msgs__msg__VehicleMocapOdometry *)malloc(sizeof(px4_msgs__msg__VehicleMocapOdometry));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__VehicleMocapOdometry__Sequence__init(px4_msgs__msg__VehicleMocapOdometry__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__VehicleMocapOdometry *)calloc(size, sizeof(px4_msgs__msg__VehicleMocapOdometry));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__VehicleMocapOdometry__Sequence * array = (px4_msgs__msg__VehicleMocapOdometry__Sequence *)malloc(sizeof(px4_msgs__msg__VehicleMocapOdometry__Sequence));
  if (!array) {
    return NULL;
  }
