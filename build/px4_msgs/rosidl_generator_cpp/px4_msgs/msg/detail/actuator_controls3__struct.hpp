...
template<typename ContainerAllocator>
constexpr uint8_t ActuatorControls3_<ContainerAllocator>::GROUP_INDEX_ALLOCATED_PART1;
template<typename ContainerAllocator>
constexpr uint8_t ActuatorControls3_<ContainerAllocator>::GROUP_INDEX_ALLOCATED_PART2;
template<typename ContainerAllocator>
