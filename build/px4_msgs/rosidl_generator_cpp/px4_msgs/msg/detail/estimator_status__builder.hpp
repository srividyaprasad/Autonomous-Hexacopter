...
class Init_EstimatorStatus_vibe
{
public:
  explicit Init_EstimatorStatus_vibe(::px4_msgs::msg::EstimatorStatus & msg)
  : msg_(msg)
  {}
  Init_EstimatorStatus_output_tracking_error vibe(::px4_msgs::msg::EstimatorStatus::_vibe_type arg)
  {
    msg_.vibe = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_EstimatorStatus_vibe timestamp_sample(::px4_msgs::msg::EstimatorStatus::_timestamp_sample_type arg)
  {
    msg_.timestamp_sample = std::move(arg);
    return Init_EstimatorStatus_vibe(msg_);
  }
