...
struct RcChannels_
{
  ...
  explicit RcChannels_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill<typename std::array<int8_t, 26>::iterator, int8_t>(this->function.begin(), this->function.end(), 0);
      this->rssi = 0;
  ...
  Type & set__function(
    const std::array<int8_t, 26> & _arg)
  {
    this->function = _arg;
    return *this;
  }
  ...
  static constexpr uint8_t FUNCTION_ARMSWITCH =
    22u;
  static constexpr uint8_t FUNCTION_STAB =
    23u;
  static constexpr uint8_t FUNCTION_AUX_6 =
    24u;
  static constexpr uint8_t FUNCTION_MAN =
    25u;
...
template<typename ContainerAllocator>
constexpr uint8_t RcChannels_<ContainerAllocator>::FUNCTION_MODE;
template<typename ContainerAllocator>
constexpr uint8_t RcChannels_<ContainerAllocator>::FUNCTION_RETURN;
template<typename ContainerAllocator>
constexpr uint8_t RcChannels_<ContainerAllocator>::FUNCTION_POSCTL;
template<typename ContainerAllocator>
...
template<typename ContainerAllocator>
constexpr uint8_t RcChannels_<ContainerAllocator>::FUNCTION_ACRO;
template<typename ContainerAllocator>
...
template<typename ContainerAllocator>
constexpr uint8_t RcChannels_<ContainerAllocator>::FUNCTION_STAB;
template<typename ContainerAllocator>
constexpr uint8_t RcChannels_<ContainerAllocator>::FUNCTION_AUX_6;
template<typename ContainerAllocator>
constexpr uint8_t RcChannels_<ContainerAllocator>::FUNCTION_MAN;
