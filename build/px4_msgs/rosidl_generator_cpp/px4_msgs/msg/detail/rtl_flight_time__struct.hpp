...
#ifndef PX4_MSGS__MSG__DETAIL__RTL_FLIGHT_TIME__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__RTL_FLIGHT_TIME__STRUCT_HPP_
...
struct RtlFlightTime_
{
  ...
  explicit RtlFlightTime_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit RtlFlightTime_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__DETAIL__RTL_FLIGHT_TIME__STRUCT_HPP_
