...
#ifndef PX4_MSGS__MSG__DETAIL__RTL_FLIGHT_TIME__TRAITS_HPP_
#define PX4_MSGS__MSG__DETAIL__RTL_FLIGHT_TIME__TRAITS_HPP_
...
template<>
inline const char * name<px4_msgs::msg::RtlFlightTime>()
{
  return "px4_msgs/msg/RtlFlightTime";
}
...
template<>
struct is_message<px4_msgs::msg::RtlFlightTime>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4_MSGS__MSG__DETAIL__RTL_FLIGHT_TIME__TRAITS_HPP_
