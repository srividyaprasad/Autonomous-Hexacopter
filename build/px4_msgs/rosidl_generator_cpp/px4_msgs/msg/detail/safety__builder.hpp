...
class Init_Safety_override_enabled
{
public:
  explicit Init_Safety_override_enabled(::px4_msgs::msg::Safety & msg)
  : msg_(msg)
  {}
  ::px4_msgs::msg::Safety override_enabled(::px4_msgs::msg::Safety::_override_enabled_type arg)
  {
    msg_.override_enabled = std::move(arg);
...
class Init_Safety_override_available
{
public:
  explicit Init_Safety_override_available(::px4_msgs::msg::Safety & msg)
  : msg_(msg)
  {}
  Init_Safety_override_enabled override_available(::px4_msgs::msg::Safety::_override_available_type arg)
  {
    msg_.override_available = std::move(arg);
    return Init_Safety_override_enabled(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_Safety_override_available safety_off(::px4_msgs::msg::Safety::_safety_off_type arg)
  {
    msg_.safety_off = std::move(arg);
    return Init_Safety_override_available(msg_);
  }
