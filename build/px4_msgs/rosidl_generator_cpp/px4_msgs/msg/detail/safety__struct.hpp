...
struct Safety_
{
  ...
  using _override_available_type =
    bool;
  _override_available_type override_available;
  using _override_enabled_type =
    bool;
  ...
  Type & set__override_available(
    const bool & _arg)
  {
    this->override_available = _arg;
    return *this;
  }
  Type & set__override_enabled(
    const bool & _arg)
  {
    this->override_enabled = _arg;
    return *this;
  }
  ...
  bool operator==(const Safety_ & other) const
  {
    ...
    if (this->override_available != other.override_available) {
      return false;
    }
    if (this->override_enabled != other.override_enabled) {
      return false;
    }
    return true;
  }
