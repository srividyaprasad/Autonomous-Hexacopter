...
class Init_SensorAccelFifo_rotation
{
public:
  explicit Init_SensorAccelFifo_rotation(::px4_msgs::msg::SensorAccelFifo & msg)
  : msg_(msg)
  {}
  ::px4_msgs::msg::SensorAccelFifo rotation(::px4_msgs::msg::SensorAccelFifo::_rotation_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_SensorAccelFifo_rotation z(::px4_msgs::msg::SensorAccelFifo::_z_type arg)
  {
    msg_.z = std::move(arg);
    return Init_SensorAccelFifo_rotation(msg_);
  }
