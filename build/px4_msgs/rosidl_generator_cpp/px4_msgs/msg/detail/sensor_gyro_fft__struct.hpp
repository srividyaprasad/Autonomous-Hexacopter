...
struct SensorGyroFft_
{
  ...
  explicit SensorGyroFft_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill<typename std::array<float, 6>::iterator, float>(this->peak_frequencies_x.begin(), this->peak_frequencies_x.end(), 0.0f);
      std::fill<typename std::array<float, 6>::iterator, float>(this->peak_frequencies_y.begin(), this->peak_frequencies_y.end(), 0.0f);
      std::fill<typename std::array<float, 6>::iterator, float>(this->peak_frequencies_z.begin(), this->peak_frequencies_z.end(), 0.0f);
    }
  }
