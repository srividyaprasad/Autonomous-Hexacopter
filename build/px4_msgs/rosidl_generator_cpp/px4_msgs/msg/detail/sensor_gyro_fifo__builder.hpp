...
class Init_SensorGyroFifo_rotation
{
public:
  explicit Init_SensorGyroFifo_rotation(::px4_msgs::msg::SensorGyroFifo & msg)
  : msg_(msg)
  {}
  ::px4_msgs::msg::SensorGyroFifo rotation(::px4_msgs::msg::SensorGyroFifo::_rotation_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_SensorGyroFifo_rotation z(::px4_msgs::msg::SensorGyroFifo::_z_type arg)
  {
    msg_.z = std::move(arg);
    return Init_SensorGyroFifo_rotation(msg_);
  }
