...
public:
  ...
  : msg_(msg)
  {}
  ::px4_msgs::msg::SensorsStatusImu gyro_healthy(::px4_msgs::msg::SensorsStatusImu::_gyro_healthy_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_SensorsStatusImu_gyro_device_id_primary accel_healthy(::px4_msgs::msg::SensorsStatusImu::_accel_healthy_type arg)
  {
