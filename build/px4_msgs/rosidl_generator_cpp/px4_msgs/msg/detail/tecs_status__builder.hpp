...
public:
  ...
  : msg_(msg)
  {}
  Init_TecsStatus_mode throttle_sp(::px4_msgs::msg::TecsStatus::_throttle_sp_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_TecsStatus_total_energy_error true_airspeed_derivative(::px4_msgs::msg::TecsStatus::_true_airspeed_derivative_type arg)
  {
