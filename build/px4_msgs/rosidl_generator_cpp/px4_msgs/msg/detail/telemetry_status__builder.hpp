...
class Init_TelemetryStatus_rx_message_count_supported
{
public:
  explicit Init_TelemetryStatus_rx_message_count_supported(::px4_msgs::msg::TelemetryStatus & msg)
  : msg_(msg)
  {}
  Init_TelemetryStatus_rx_message_lost_count rx_message_count_supported(::px4_msgs::msg::TelemetryStatus::_rx_message_count_supported_type arg)
  {
    msg_.rx_message_count_supported = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_TelemetryStatus_rx_message_count_supported rx_message_count(::px4_msgs::msg::TelemetryStatus::_rx_message_count_type arg)
  {
    msg_.rx_message_count = std::move(arg);
    return Init_TelemetryStatus_rx_message_count_supported(msg_);
  }
