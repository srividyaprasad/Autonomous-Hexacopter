...
struct TelemetryStatus_
{
  ...
  explicit TelemetryStatus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->rx_message_count_supported = 0ul;
  ...
  using _rx_message_count_supported_type =
    uint32_t;
  _rx_message_count_supported_type rx_message_count_supported;
  ...
  Type & set__rx_message_count_supported(
    const uint32_t & _arg)
  {
    this->rx_message_count_supported = _arg;
    return *this;
  }
  ...
  bool operator==(const TelemetryStatus_ & other) const
  {
    ...
    if (this->rx_message_count_supported != other.rx_message_count_supported) {
      return false;
    }
