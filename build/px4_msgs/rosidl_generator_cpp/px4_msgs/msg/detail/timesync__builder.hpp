...
class Init_Timesync_sys_id
{
public:
  explicit Init_Timesync_sys_id(::px4_msgs::msg::Timesync & msg)
  : msg_(msg)
  {}
  Init_Timesync_seq sys_id(::px4_msgs::msg::Timesync::_sys_id_type arg)
  {
    msg_.sys_id = std::move(arg);
...
public:
  ...
  {}
  Init_Timesync_sys_id timestamp(::px4_msgs::msg::Timesync::_timestamp_type arg)
  {
    msg_.timestamp = std::move(arg);
    return Init_Timesync_sys_id(msg_);
  }
