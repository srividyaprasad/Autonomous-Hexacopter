...
class Init_VehicleConstraints_speed_xy
{
public:
  explicit Init_VehicleConstraints_speed_xy(::px4_msgs::msg::VehicleConstraints & msg)
  : msg_(msg)
  {}
  Init_VehicleConstraints_speed_up speed_xy(::px4_msgs::msg::VehicleConstraints::_speed_xy_type arg)
  {
    msg_.speed_xy = std::move(arg);
...
public:
  ...
  {}
  Init_VehicleConstraints_speed_xy timestamp(::px4_msgs::msg::VehicleConstraints::_timestamp_type arg)
  {
    msg_.timestamp = std::move(arg);
    return Init_VehicleConstraints_speed_xy(msg_);
  }
