...
class Init_VehicleControlMode_flag_external_manual_override_ok
{
public:
  explicit Init_VehicleControlMode_flag_external_manual_override_ok(::px4_msgs::msg::VehicleControlMode & msg)
  : msg_(msg)
  {}
  Init_VehicleControlMode_flag_control_manual_enabled flag_external_manual_override_ok(::px4_msgs::msg::VehicleControlMode::_flag_external_manual_override_ok_type arg)
  {
    msg_.flag_external_manual_override_ok = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_VehicleControlMode_flag_external_manual_override_ok flag_armed(::px4_msgs::msg::VehicleControlMode::_flag_armed_type arg)
  {
    msg_.flag_armed = std::move(arg);
    return Init_VehicleControlMode_flag_external_manual_override_ok(msg_);
  }
