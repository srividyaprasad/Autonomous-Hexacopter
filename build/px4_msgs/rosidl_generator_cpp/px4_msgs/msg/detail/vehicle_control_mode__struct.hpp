...
struct VehicleControlMode_
{
  ...
  using _flag_external_manual_override_ok_type =
    bool;
  ...
  Type & set__flag_external_manual_override_ok(
    const bool & _arg)
  {
    this->flag_external_manual_override_ok = _arg;
    return *this;
  }
  ...
  bool operator==(const VehicleControlMode_ & other) const
  {
    ...
    if (this->flag_external_manual_override_ok != other.flag_external_manual_override_ok) {
      return false;
    }
