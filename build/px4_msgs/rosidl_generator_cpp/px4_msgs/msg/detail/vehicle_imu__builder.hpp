...
class Init_VehicleImu_calibration_count
{
public:
  explicit Init_VehicleImu_calibration_count(::px4_msgs::msg::VehicleImu & msg)
  : msg_(msg)
  {}
  ::px4_msgs::msg::VehicleImu calibration_count(::px4_msgs::msg::VehicleImu::_calibration_count_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_VehicleImu_calibration_count delta_velocity_clipping(::px4_msgs::msg::VehicleImu::_delta_velocity_clipping_type arg)
  {
    msg_.delta_velocity_clipping = std::move(arg);
    return Init_VehicleImu_calibration_count(msg_);
  }
