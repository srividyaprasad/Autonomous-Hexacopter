...
public:
  ...
  : msg_(msg)
  {}
  Init_VehicleImuStatus_temperature_accel mean_gyro(::px4_msgs::msg::VehicleImuStatus::_mean_gyro_type arg)
  {
...
class Init_VehicleImuStatus_gyro_coning_vibration
{
public:
  explicit Init_VehicleImuStatus_gyro_coning_vibration(::px4_msgs::msg::VehicleImuStatus & msg)
  : msg_(msg)
  {}
  Init_VehicleImuStatus_mean_accel gyro_coning_vibration(::px4_msgs::msg::VehicleImuStatus::_gyro_coning_vibration_type arg)
  {
    msg_.gyro_coning_vibration = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_VehicleImuStatus_gyro_coning_vibration gyro_vibration_metric(::px4_msgs::msg::VehicleImuStatus::_gyro_vibration_metric_type arg)
  {
    msg_.gyro_vibration_metric = std::move(arg);
    return Init_VehicleImuStatus_gyro_coning_vibration(msg_);
  }
