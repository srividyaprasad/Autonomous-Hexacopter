...
struct VehicleImuStatus_
{
  ...
  explicit VehicleImuStatus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->gyro_coning_vibration = 0.0f;
  ...
  using _gyro_coning_vibration_type =
    float;
  ...
  Type & set__gyro_coning_vibration(
    const float & _arg)
  {
    this->gyro_coning_vibration = _arg;
    return *this;
  }
  ...
  bool operator==(const VehicleImuStatus_ & other) const
  {
    ...
    if (this->gyro_coning_vibration != other.gyro_coning_vibration) {
      return false;
    }
