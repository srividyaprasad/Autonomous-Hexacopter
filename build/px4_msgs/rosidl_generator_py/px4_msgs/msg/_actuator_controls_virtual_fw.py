...
class Metaclass_ActuatorControlsVirtualFw(type):
    ...
    def GROUP_INDEX_ALLOCATED_PART1(self):
        ...
        return Metaclass_ActuatorControlsVirtualFw.__constants['GROUP_INDEX_ALLOCATED_PART1']

    @property
    def GROUP_INDEX_ALLOCATED_PART2(self):
        """Message constant 'GROUP_INDEX_ALLOCATED_PART2'."""
        return Metaclass_ActuatorControlsVirtualFw.__constants['GROUP_INDEX_ALLOCATED_PART2']
