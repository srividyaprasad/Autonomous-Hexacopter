...
class AirspeedWind(metaclass=Metaclass_AirspeedWind):
    ...
    def __init__(self, **kwargs):
        ...
        self.tas_scale = kwargs.get('tas_scale', float())
    ...
    def __eq__(self, other):
        ...
        if self.tas_innov_var != other.tas_innov_var:
            return False
        if self.tas_scale != other.tas_scale:
            return False
    ...
    @property
    def tas_scale(self):
        """Message field 'tas_scale'."""
        return self._tas_scale

    @tas_scale.setter
    def tas_scale(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'tas_scale' field must be of type 'float'"
        self._tas_scale = value
