...
bool px4_msgs__msg__camera_trigger_secondary__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._camera_trigger_secondary.CameraTriggerSecondary", full_classname_dest, 61) == 0);
  }
  px4_msgs__msg__CameraTriggerSecondary * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of CameraTriggerSecondary */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._camera_trigger_secondary");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CameraTriggerSecondary");
