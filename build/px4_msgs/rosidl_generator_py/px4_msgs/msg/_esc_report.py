...
class EscReport(metaclass=Metaclass_EscReport):
    ...
    def __init__(self, **kwargs):
        ...
        self.esc_temperature = kwargs.get('esc_temperature', int())
    ...
    def esc_temperature(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'esc_temperature' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'esc_temperature' field must be an unsigned integer in [0, 255]"
