...
class Px4IoStatus(metaclass=Metaclass_Px4IoStatus):
    ...
    __slots__ = [
        ...
        '_arming_manual_override_ok',
        '_arming_failsafe_custom',
        '_arming_inair_restart_ok',
        '_arming_always_pwm_enable',
        '_arming_rc_handling_disabled',
        '_arming_lockdown',
        '_arming_force_failsafe',
        '_arming_termination_failsafe',
        '_arming_override_immediate',
        '_actuators',
        '_servos',
        '_raw_inputs',
    ]
    ...
    _fields_and_field_types = {
        ...
        'alarm_vbatt_low': 'boolean',
        'alarm_temperature': 'boolean',
        'alarm_servo_current': 'boolean',
        'alarm_acc_current': 'boolean',
        'alarm_fmu_lost': 'boolean',
        'alarm_rc_lost': 'boolean',
        'alarm_pwm_error': 'boolean',
        'alarm_vservo_fault': 'boolean',
        'arming_io_arm_ok': 'boolean',
        'arming_fmu_armed': 'boolean',
        'arming_fmu_prearmed': 'boolean',
        'arming_manual_override_ok': 'boolean',
        'arming_failsafe_custom': 'boolean',
        'arming_inair_restart_ok': 'boolean',
        'arming_always_pwm_enable': 'boolean',
        'arming_rc_handling_disabled': 'boolean',
        'arming_lockdown': 'boolean',
        'arming_force_failsafe': 'boolean',
        'arming_termination_failsafe': 'boolean',
        'arming_override_immediate': 'boolean',
        'actuators': 'int16[8]',
        'servos': 'uint16[8]',
    ...
    def __init__(self, **kwargs):
        ...
        self.status_override = kwargs.get('status_override', bool())
        ...
        self.status_mixer_ok = kwargs.get('status_mixer_ok', bool())
        ...
        self.alarm_vbatt_low = kwargs.get('alarm_vbatt_low', bool())
        self.alarm_temperature = kwargs.get('alarm_temperature', bool())
        self.alarm_servo_current = kwargs.get('alarm_servo_current', bool())
        self.alarm_acc_current = kwargs.get('alarm_acc_current', bool())
        self.alarm_fmu_lost = kwargs.get('alarm_fmu_lost', bool())
        self.alarm_rc_lost = kwargs.get('alarm_rc_lost', bool())
        self.alarm_pwm_error = kwargs.get('alarm_pwm_error', bool())
        self.alarm_vservo_fault = kwargs.get('alarm_vservo_fault', bool())
        ...
        self.arming_manual_override_ok = kwargs.get('arming_manual_override_ok', bool())
        self.arming_failsafe_custom = kwargs.get('arming_failsafe_custom', bool())
        self.arming_inair_restart_ok = kwargs.get('arming_inair_restart_ok', bool())
        self.arming_always_pwm_enable = kwargs.get('arming_always_pwm_enable', bool())
        self.arming_rc_handling_disabled = kwargs.get('arming_rc_handling_disabled', bool())
        ...
        self.arming_override_immediate = kwargs.get('arming_override_immediate', bool())
        if 'actuators' not in kwargs:
            self.actuators = numpy.zeros(8, dtype=numpy.int16)
        else:
            self.actuators = numpy.array(kwargs.get('actuators'), dtype=numpy.int16)
            assert self.actuators.shape == (8, )
        if 'servos' not in kwargs:
            self.servos = numpy.zeros(8, dtype=numpy.uint16)
        else:
            self.servos = numpy.array(kwargs.get('servos'), dtype=numpy.uint16)
            assert self.servos.shape == (8, )
    ...
    def __eq__(self, other):
        ...
        if self.status_outputs_armed != other.status_outputs_armed:
            return False
        if self.status_override != other.status_override:
            return False
        ...
        if self.status_raw_pwm != other.status_raw_pwm:
            return False
        if self.status_mixer_ok != other.status_mixer_ok:
            return False
        ...
        if self.status_rc_sumd != other.status_rc_sumd:
            return False
        if self.alarm_vbatt_low != other.alarm_vbatt_low:
            return False
        if self.alarm_temperature != other.alarm_temperature:
            return False
        if self.alarm_servo_current != other.alarm_servo_current:
            return False
        if self.alarm_acc_current != other.alarm_acc_current:
            return False
        if self.alarm_fmu_lost != other.alarm_fmu_lost:
            return False
        if self.alarm_rc_lost != other.alarm_rc_lost:
            return False
        if self.alarm_pwm_error != other.alarm_pwm_error:
            return False
        if self.alarm_vservo_fault != other.alarm_vservo_fault:
            return False
        ...
        if self.arming_fmu_prearmed != other.arming_fmu_prearmed:
            return False
        if self.arming_manual_override_ok != other.arming_manual_override_ok:
            return False
        if self.arming_failsafe_custom != other.arming_failsafe_custom:
            return False
        if self.arming_inair_restart_ok != other.arming_inair_restart_ok:
            return False
        if self.arming_always_pwm_enable != other.arming_always_pwm_enable:
            return False
        if self.arming_rc_handling_disabled != other.arming_rc_handling_disabled:
            return False
        ...
        if self.arming_termination_failsafe != other.arming_termination_failsafe:
            return False
        if self.arming_override_immediate != other.arming_override_immediate:
            return False
        if all(self.actuators != other.actuators):
            return False
        if all(self.servos != other.servos):
            return False
    ...
    def status_override(self):
        """Message field 'status_override'."""
        return self._status_override

    @status_override.setter
    def status_override(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'status_override' field must be of type 'bool'"
    ...
    @property
    def status_mixer_ok(self):
        """Message field 'status_mixer_ok'."""
        return self._status_mixer_ok

    @status_mixer_ok.setter
    def status_mixer_ok(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'status_mixer_ok' field must be of type 'bool'"
        self._status_mixer_ok = value
    ...
    @property
    def alarm_vbatt_low(self):
        """Message field 'alarm_vbatt_low'."""
        return self._alarm_vbatt_low

    @alarm_vbatt_low.setter
    def alarm_vbatt_low(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'alarm_vbatt_low' field must be of type 'bool'"
        self._alarm_vbatt_low = value

    @property
    def alarm_temperature(self):
        """Message field 'alarm_temperature'."""
        return self._alarm_temperature

    @alarm_temperature.setter
    def alarm_temperature(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'alarm_temperature' field must be of type 'bool'"
        self._alarm_temperature = value

    @property
    def alarm_servo_current(self):
        """Message field 'alarm_servo_current'."""
        return self._alarm_servo_current

    @alarm_servo_current.setter
    def alarm_servo_current(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'alarm_servo_current' field must be of type 'bool'"
        self._alarm_servo_current = value

    @property
    def alarm_acc_current(self):
        """Message field 'alarm_acc_current'."""
        return self._alarm_acc_current

    @alarm_acc_current.setter
    def alarm_acc_current(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'alarm_acc_current' field must be of type 'bool'"
        self._alarm_acc_current = value

    @property
    def alarm_fmu_lost(self):
        """Message field 'alarm_fmu_lost'."""
        return self._alarm_fmu_lost

    @alarm_fmu_lost.setter
    def alarm_fmu_lost(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'alarm_fmu_lost' field must be of type 'bool'"
        self._alarm_fmu_lost = value
    ...
    @property
    def alarm_vservo_fault(self):
        """Message field 'alarm_vservo_fault'."""
        return self._alarm_vservo_fault

    @alarm_vservo_fault.setter
    def alarm_vservo_fault(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'alarm_vservo_fault' field must be of type 'bool'"
        self._alarm_vservo_fault = value
    ...
    @property
    def arming_manual_override_ok(self):
        """Message field 'arming_manual_override_ok'."""
        return self._arming_manual_override_ok

    @arming_manual_override_ok.setter
    def arming_manual_override_ok(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'arming_manual_override_ok' field must be of type 'bool'"
        self._arming_manual_override_ok = value
    ...
    @property
    def arming_inair_restart_ok(self):
        """Message field 'arming_inair_restart_ok'."""
        return self._arming_inair_restart_ok

    @arming_inair_restart_ok.setter
    def arming_inair_restart_ok(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'arming_inair_restart_ok' field must be of type 'bool'"
        self._arming_inair_restart_ok = value

    @property
    def arming_always_pwm_enable(self):
        """Message field 'arming_always_pwm_enable'."""
        return self._arming_always_pwm_enable

    @arming_always_pwm_enable.setter
    def arming_always_pwm_enable(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'arming_always_pwm_enable' field must be of type 'bool'"
        self._arming_always_pwm_enable = value

    @property
    def arming_rc_handling_disabled(self):
        """Message field 'arming_rc_handling_disabled'."""
        return self._arming_rc_handling_disabled

    @arming_rc_handling_disabled.setter
    def arming_rc_handling_disabled(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'arming_rc_handling_disabled' field must be of type 'bool'"
        self._arming_rc_handling_disabled = value
    ...
    @property
    def arming_override_immediate(self):
        """Message field 'arming_override_immediate'."""
        return self._arming_override_immediate

    @arming_override_immediate.setter
    def arming_override_immediate(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'arming_override_immediate' field must be of type 'bool'"
        self._arming_override_immediate = value
    ...
    def actuators(self, value):
        if isinstance(value, numpy.ndarray):
            assert value.dtype == numpy.int16, \
                "The 'actuators' numpy.ndarray() must have the dtype of 'numpy.int16'"
            assert value.size == 8, \
                "The 'actuators' numpy.ndarray() must have a size of 8"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'actuators' field must be a set or sequence with length 8 and each value of type 'int' and each integer in [-32768, 32767]"
        self._actuators = numpy.array(value, dtype=numpy.int16)
    ...
    def servos(self, value):
        if isinstance(value, numpy.ndarray):
            assert value.dtype == numpy.uint16, \
                "The 'servos' numpy.ndarray() must have the dtype of 'numpy.uint16'"
            assert value.size == 8, \
                "The 'servos' numpy.ndarray() must have a size of 8"
            self._servos = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ...
                "The 'servos' field must be a set or sequence with length 8 and each value of type 'int' and each unsigned integer in [0, 65535]"
        self._servos = numpy.array(value, dtype=numpy.uint16)
