...
bool px4_msgs__msg__safety__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // override_available
    PyObject * field = PyObject_GetAttrString(_pymsg, "override_available");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->override_available = (Py_True == field);
    Py_DECREF(field);
  }
  {  // override_enabled
    PyObject * field = PyObject_GetAttrString(_pymsg, "override_enabled");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->override_enabled = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * px4_msgs__msg__safety__convert_to_py(void * raw_ros_message)
{
  ...
  {  // override_available
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->override_available ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "override_available", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // override_enabled
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->override_enabled ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "override_enabled", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
