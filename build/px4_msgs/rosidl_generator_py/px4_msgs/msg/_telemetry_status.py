...
class TelemetryStatus(metaclass=Metaclass_TelemetryStatus):
    ...
    _fields_and_field_types = {
        ...
        'rx_message_count_supported': 'uint32',
    ...
    def __init__(self, **kwargs):
        ...
        self.rx_message_count_supported = kwargs.get('rx_message_count_supported', int())
    ...
    def __eq__(self, other):
        ...
        if self.rx_message_count != other.rx_message_count:
            return False
        if self.rx_message_count_supported != other.rx_message_count_supported:
            return False
    ...
    @property
    def rx_message_count_supported(self):
        """Message field 'rx_message_count_supported'."""
        return self._rx_message_count_supported

    @rx_message_count_supported.setter
    def rx_message_count_supported(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'rx_message_count_supported' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'rx_message_count_supported' field must be an unsigned integer in [0, 4294967295]"
        self._rx_message_count_supported = value
