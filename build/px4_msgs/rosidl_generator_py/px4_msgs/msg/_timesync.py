...
class Timesync(metaclass=Metaclass_Timesync):
    ...
    def __init__(self, **kwargs):
        ...
        self.sys_id = kwargs.get('sys_id', int())
    ...
    @property
    def sys_id(self):
        """Message field 'sys_id'."""
        return self._sys_id

    @sys_id.setter
    def sys_id(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'sys_id' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'sys_id' field must be an unsigned integer in [0, 255]"
        self._sys_id = value
