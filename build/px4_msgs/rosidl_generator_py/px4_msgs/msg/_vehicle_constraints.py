...
class VehicleConstraints(metaclass=Metaclass_VehicleConstraints):
    ...
    def __init__(self, **kwargs):
        ...
        self.speed_xy = kwargs.get('speed_xy', float())
    ...
    def __eq__(self, other):
        ...
        if self.timestamp != other.timestamp:
            return False
        if self.speed_xy != other.speed_xy:
            return False
    ...
    @property
    def speed_xy(self):
        """Message field 'speed_xy'."""
        return self._speed_xy

    @speed_xy.setter
    def speed_xy(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'speed_xy' field must be of type 'float'"
        self._speed_xy = value
