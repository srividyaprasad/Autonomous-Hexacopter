...
class VehicleControlMode(metaclass=Metaclass_VehicleControlMode):
    ...
    __slots__ = [
        '_timestamp',
        '_flag_armed',
        '_flag_external_manual_override_ok',
    ...
    _fields_and_field_types = {
        'timestamp': 'uint64',
        'flag_armed': 'boolean',
        'flag_external_manual_override_ok': 'boolean',
    ...
    def __init__(self, **kwargs):
        ...
        self.flag_external_manual_override_ok = kwargs.get('flag_external_manual_override_ok', bool())
    ...
    def __eq__(self, other):
        ...
        if self.flag_armed != other.flag_armed:
            return False
        if self.flag_external_manual_override_ok != other.flag_external_manual_override_ok:
            return False
    ...
    @property
    def flag_external_manual_override_ok(self):
        """Message field 'flag_external_manual_override_ok'."""
        return self._flag_external_manual_override_ok

    @flag_external_manual_override_ok.setter
    def flag_external_manual_override_ok(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'flag_external_manual_override_ok' field must be of type 'bool'"
        self._flag_external_manual_override_ok = value
