...
bool px4_msgs__msg__vehicle_control_mode__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // flag_external_manual_override_ok
    PyObject * field = PyObject_GetAttrString(_pymsg, "flag_external_manual_override_ok");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->flag_external_manual_override_ok = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * px4_msgs__msg__vehicle_control_mode__convert_to_py(void * raw_ros_message)
{
  ...
  {  // flag_external_manual_override_ok
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->flag_external_manual_override_ok ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "flag_external_manual_override_ok", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
