...
class VehicleImuStatus(metaclass=Metaclass_VehicleImuStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.gyro_coning_vibration = kwargs.get('gyro_coning_vibration', float())
    ...
    def __eq__(self, other):
        ...
        if self.gyro_vibration_metric != other.gyro_vibration_metric:
            return False
        if self.gyro_coning_vibration != other.gyro_coning_vibration:
            return False
    ...
    @property
    def gyro_coning_vibration(self):
        """Message field 'gyro_coning_vibration'."""
        return self._gyro_coning_vibration

    @gyro_coning_vibration.setter
    def gyro_coning_vibration(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'gyro_coning_vibration' field must be of type 'float'"
        self._gyro_coning_vibration = value
