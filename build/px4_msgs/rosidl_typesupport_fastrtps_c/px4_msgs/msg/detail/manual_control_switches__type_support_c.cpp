  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: mode_switch
  {
    cdr << ros_message->mode_switch;
  }

  // Field name: man_switch
  {
    cdr << ros_message->man_switch;
  }

  // Field name: acro_switch
  {
    cdr << ros_message->acro_switch;
  }

  // Field name: stab_switch
  {
    cdr << ros_message->stab_switch;
  }

  // Field name: posctl_switch
  {
    cdr << ros_message->posctl_switch;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name man_switch
  {
    size_t item_size = sizeof(ros_message->man_switch);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name acro_switch
  {
    size_t item_size = sizeof(ros_message->acro_switch);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name stab_switch
  ...
  // field.name posctl_switch
  {
    size_t item_size = sizeof(ros_message->posctl_switch);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name switch_changes
