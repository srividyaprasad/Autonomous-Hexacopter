  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: override_available
  {
    cdr << (ros_message->override_available ? true : false);
  }

  // Field name: override_enabled
  {
    cdr << (ros_message->override_enabled ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: override_available
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->override_available = tmp ? true : false;
  }
  ...
  // Field name: override_enabled
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->override_enabled = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name override_available
  {
    size_t item_size = sizeof(ros_message->override_available);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name override_enabled
  {
    size_t item_size = sizeof(ros_message->override_enabled);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  // member: override_available
  {
    size_t array_size = 1;

    current_alignment += array_size * sizeof(uint8_t);
  }
  // member: override_enabled
  {
    size_t array_size = 1;
