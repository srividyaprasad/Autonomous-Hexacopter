  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: flag_external_manual_override_ok
  {
    cdr << (ros_message->flag_external_manual_override_ok ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: flag_external_manual_override_ok
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->flag_external_manual_override_ok = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // member: flag_external_manual_override_ok
  {
    size_t array_size = 1;
