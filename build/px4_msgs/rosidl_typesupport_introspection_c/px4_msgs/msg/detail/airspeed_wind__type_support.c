...
static rosidl_typesupport_introspection_c__MessageMember AirspeedWind__rosidl_typesupport_introspection_c__AirspeedWind_message_member_array[12] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__AirspeedWind, tas_scale),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
