...
#include <stddef.h>
#include "px4_msgs/msg/detail/ekf_gps_drift__rosidl_typesupport_introspection_c.h"
...
void EkfGpsDrift__rosidl_typesupport_introspection_c__EkfGpsDrift_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  px4_msgs__msg__EkfGpsDrift__init(message_memory);
}

void EkfGpsDrift__rosidl_typesupport_introspection_c__EkfGpsDrift_fini_function(void * message_memory)
{
  px4_msgs__msg__EkfGpsDrift__fini(message_memory);
}
...
static const rosidl_typesupport_introspection_c__MessageMembers EkfGpsDrift__rosidl_typesupport_introspection_c__EkfGpsDrift_message_members = {
  ...
  EkfGpsDrift__rosidl_typesupport_introspection_c__EkfGpsDrift_init_function,  // function to initialize message memory (memory has to be allocated)
  EkfGpsDrift__rosidl_typesupport_introspection_c__EkfGpsDrift_fini_function  // function to terminate message instance (will not free memory)
};
