...
static rosidl_typesupport_introspection_c__MessageMember SensorAccelFifo__rosidl_typesupport_introspection_c__SensorAccelFifo_message_member_array[10] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__SensorAccelFifo, rotation),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
