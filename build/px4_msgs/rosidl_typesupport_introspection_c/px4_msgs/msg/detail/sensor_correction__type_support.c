...
static rosidl_typesupport_introspection_c__MessageMember SensorCorrection__rosidl_typesupport_introspection_c__SensorCorrection_message_member_array[16] = {
  {
    "timestamp",  // name
