...
static rosidl_typesupport_introspection_c__MessageMember SensorsStatusImu__rosidl_typesupport_introspection_c__SensorsStatusImu_message_member_array[9] = {
  {
    "timestamp",  // name
