...
#include <stddef.h>
#include "px4_msgs/msg/detail/vehicle_actuator_setpoint__rosidl_typesupport_introspection_c.h"
...
void VehicleActuatorSetpoint__rosidl_typesupport_introspection_c__VehicleActuatorSetpoint_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  px4_msgs__msg__VehicleActuatorSetpoint__init(message_memory);
}

void VehicleActuatorSetpoint__rosidl_typesupport_introspection_c__VehicleActuatorSetpoint_fini_function(void * message_memory)
{
  px4_msgs__msg__VehicleActuatorSetpoint__fini(message_memory);
}
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleActuatorSetpoint__rosidl_typesupport_introspection_c__VehicleActuatorSetpoint_message_members = {
  ...
  VehicleActuatorSetpoint__rosidl_typesupport_introspection_c__VehicleActuatorSetpoint_init_function,  // function to initialize message memory (memory has to be allocated)
  VehicleActuatorSetpoint__rosidl_typesupport_introspection_c__VehicleActuatorSetpoint_fini_function  // function to terminate message instance (will not free memory)
};
