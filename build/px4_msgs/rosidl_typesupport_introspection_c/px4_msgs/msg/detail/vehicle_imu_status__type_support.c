...
static rosidl_typesupport_introspection_c__MessageMember VehicleImuStatus__rosidl_typesupport_introspection_c__VehicleImuStatus_message_member_array[17] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__VehicleImuStatus, gyro_coning_vibration),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
